  ...
  <div class="box margin-top-20">
    <article class="media">
      <div class="media-content">
        <div class="content">
          <p>
            <strong>Como cadastrar um novo Usuario?</strong>
            <br>
            Para cadastrar um novo usuario você precisa ter permissão de nivel U ou O.
            Com a permissâo concedida, basta ir até o menu superior e escolher a opção Cadastrar. Após isso basta concluir o cadastro preenchendo o formulario, selecionando o nivel de permissão do usuario a ser cadastrado e clicando em Cadastrar.
          </p>
        </div>
      </div>
    </article>
  ...
  <div class="box margin-top-20">
    <article class="media">
      <div class="media-content">
        <div class="content">
          <p>
            <strong>Como visualizar os Relatorios?</strong>
            <br>
            Para visualizar relatorios você precisa ter permissão de nivel U ou O.
            Com a permissâo concedida, basta ir até o menu superior e escolher a opção Relatorios. Após isso basta escolher o filtro de data e clicar em filtrar. Uma tabela deve aparecer logo abaixo do texto 'Entrada'.
          </p>
        </div>
      </div>
    </article>
